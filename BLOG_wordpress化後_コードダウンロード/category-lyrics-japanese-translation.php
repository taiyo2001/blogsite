...
<?php get_header('blog'); ?>
    ...
    <div class="wrapper">
        ...
        <main class="main">
            ...
            <article class="parent-category">
                <h2 class="main__ttl">アーティスト一覧</h2>
                <ul class="parent-category-list">
                    ...
                    ?>
                        ...
                        <li><a href="<?= esc_url(get_category_link($value->term_id)) ?>"><span>・</span><p><?= esc_html($value->name) ?>(<?= esc_html($value->count) ?>)</p></a></li>
                        <?php endforeach; ?>
            ...
            <article class="category">
                ...
                $args = array(
                    ...
                    'cat' => 3,
                    'numberposts' => 2,
                    'posts_per_page' => 12, //12 最大表示件数を設定
