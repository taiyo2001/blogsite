...
<?php get_header(); ?>
        ...
        <div class="mv">
            ...
            <div class="scroll-prompt-box">
                <img class="scroll-img" src="<?php echo get_template_directory_uri(); ?>/img/arrow-yellow.png" alt="">
            ...
            <div class="section__wrapper about">
                ...
                <div class="section__wrapper_content about its-me">
                    ...
                    <div class="section__wrapper_content_box about">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/about_1.jpg" alt="" class="section__wrapper_content_box_img about">
        ...
        <section class="Blog" id="blog">
            <div class="Blog__content-left">
                <a class="" href="<?php echo esc_url( home_url('/') ); ?>"></a>
            </div>
            <div class="Blog__content-right">
                <h2 class="Blog-ttl">BLOG</h2>
                <div class="Blog__txt-wrapper">
                    <p class="Blog-txt">
                        趣味としてブログサイトの運営をしております。
                        よろしければご覧ください。
                    </p>
                </div>
                <a class="button" href="<?php echo esc_url( home_url('/') ); ?>">ブログを見る</a>
            </div>
        </section>
                            ...
                            <ul class="service-box_skill-content_list js-wipe">
                                <li class="service-box_skill-content_item js-slide-left">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_1.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                ...
                                <li class="service-box_skill-content_item js-slide-top">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_2.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                    <div class="service-box_skill-content_item_ttl-box">
                                ...
                                <li class="service-box_skill-content_item js-slide-right">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_3.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                    <div class="service-box_skill-content_item_ttl-box">
                                ...
                                <li class="service-box_skill-content_item js-slide-left">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_4.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                    <div class="service-box_skill-content_item_ttl-box">
                                ...
                                <li class="service-box_skill-content_item js-slide-bottom">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_5.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                    <div class="service-box_skill-content_item_ttl-box">
                                ...
                                <li class="service-box_skill-content_item js-slide-right">
                                    <div class="service-box_skill-content_item_img-box">
                                        <div class="wrapper">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/skill_6.png" alt="" class="service-box_skill-content_item_img-box_img">
                                        </div>
                                    </div>
                                    <div class="service-box_skill-content_item_ttl-box">
                    ...
                    <ul class="work-slider slider js-slider">
                        <li class="work-slider_item">
                            <a href="" class="work-slider_item_link">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/work_1.jpg" alt="" class="work-slider_item_link_img">
                            </a>
                        ...
                        <li class="work-slider_item">
                            <a href="<?php echo esc_url( home_url('/') ); ?>" class="work-slider_item_link">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/blogphoto.png" alt="" class="work-slider_item_link_img">
                            </a>
                            <div class="work-slider_item_txt-box slick-txt">
                                <p class="work-slider_item_txt-box_txt">name：自作ブログサイト</p>
                                <p class="work-slider_item_txt-box_txt">period:1 months</p>
                            </div>
                        </li>
                        <li class="work-slider_item">
                            <a href="" class="work-slider_item_link">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/work_wait2.jpg" alt="" class="work-slider_item_link_img">
                            </a>
                            <div class="work-slider_item_txt-box slick-txt">
